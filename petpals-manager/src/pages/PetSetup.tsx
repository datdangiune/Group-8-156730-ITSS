  ...
  // Handle form submission
    ...
    useEffect(() => {
        const fetchData = async (id: string) => {
            if (!id || !token) {
                console.log("Missing ID or token, skipping fetch");
                return;
            }
            ...
            <Form {...form}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    render={({ field }) => (
                        ...
                        >
                            <FormControl>
                            <SelectTrigger>
                                <SelectValue placeholder={`${pet?.health_status} || ""`}  />
                            </SelectTrigger>
                            </FormControl>
                            <SelectContent>
                ...
                <div className="space-y-4">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Textarea 
                            placeholder={`${pet?.vaccination_history} || ""`} 
                            {...field} 
                            className="min-h-24"
                            />
                        </FormControl>
